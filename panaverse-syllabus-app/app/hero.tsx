...
export default function Hero() {
    return (
        <>
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">
                            <a href="https://www.citivelocity.com/citigps/metaverse-and-money/">Citi</a>
                        </h2>
                        <p className="text-gray-500">The new Wall Street Business</p>
                    </div>
                </div>
            </section>


            <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mt-50">Core Courses (Common in All Specializations):</h1>
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900">Every participant of the program will start by completing the following three core courses:</h1>
            ...
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mt-50">Specialized Tracks:</h1>
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900">After completing the first three quarters the participants will select one or more specializations consisting of two courses each:</h1>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap -m-4">
                        <div className="p-4 lg:w-1/3">
            ...
            <br />
            <br />
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mt-100">The Outcome for Participants of the Program</h1>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="inline-block w-8 h-8 text-gray-400 mb-8" viewBox="0 0 975.036 975.036">
