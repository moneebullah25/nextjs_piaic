    ...
    return (
        <>
            <div className="container my-24 px-6 mx-auto">
                <section className="mb-32 text-black-800">
                    <p style={{textAlign: 'center'}}>
                        <strong><u>Web 3 and Metaverse Specialization</u></strong>
                    </p>
                    <p>
                        <strong></strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        <strong>Quarter IV</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        <strong>
                    ...
                    <p>
                        <strong><u>Course Outline:</u></strong>
                        <strong> </strong>
                    </p>
                    <ol start={parseInt("1")} type="1">
                        <li>
                    ...
                    <p>
                        ICO list at ICO Drops	<a href="https://icodrops.com/">https://icodrops.com</a>
                    </p>
                    <p>
                        ICO List of Best New Initial Coin Offerings	<a href="https://topicolist.com/">https://topicolist.com/</a>
                    </p>
                    <p>
                    ...
                    <p>
                        IEO List <a href="https://icomarks.com/ieo">https://icomarks.com/ieo</a>
                    </p>
                    <p>
                        Polkastarter	<a href="https://polkastarter.com/">https://polkastarter.com</a>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        how to start a IDO on the Polkastarter	<a href="https://polkastarter.com/">https://polkastarter.com/</a>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        our Pako Token. In order to do that we need to set a price for our token (1
                        ETH = 100 Pako Token)
                    </p>
                    <p>
                    ...
                    <p>
                        While it's always good to test your code, it's often more satisfying to see
                        the results of your work wrapped in a nice UI. Let's see how we can deploy
                        our contracts and get some Pako tokens into our MetaMask wallet!
                    </p>
                    <p>
                        We start by running our deployment scripts for the test network so that the
                        new token contracts are uploaded and deployed.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        contract address. If your MetaMask wallet doesn't have any ethers, remember
                        that you can use any faucet.
                    </p>
                    <p>
                    ...
                    <p>
                        Once you're on the token page, click on "Add custom token" and paste in the
                        token contract's address in the address field.
                    </p>
                    <p>
                    ...
                    <p>
                        Now use Gnosis Safe <a href="https://gnosis-safe.io/">https://gnosis-safe.io/</a> with
                    ...
                    <p>
                        ...
                        <a href="https://ethereum.org/en/developers/tutorials/send-token-etherjs/">
                    ...
                    <p>
                        Deploy your NFT contract on a testnet, mint it, and view it on the MetaMask
                        wallet and list it on OpenSea Marketplace	<a href="https://opensea.io/">https://opensea.io/</a> for sale.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        anything else. The metaverse should replicate the best qualities of the web
                        - it should just be the web. We just have to extend online responsive
                    ...
                    <ol start={parseInt("1")} type="1">
                        <li>
                            <strong>Open Metaverse Web Development </strong>
                        </li>
                    </ol>
                    <p>
                        <strong></strong>
                    ...
                    <p>
                        Modeling a Time Machine using Blender 3 as shown in chapters 3 and 4 of the
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>
                            <u>Artificial Intelligence (AI) and Deep Learning Specialization</u>
                        </strong>
                    </p>
                    <p>
                        <strong></strong>
                    ...
                    <p>
                        ...
                        by machines, especially computer systems. The AI and Deep Learning
                        Specialization is a foundational program that will aid in your
                        comprehension of deep learning's potential, difficulties, and effects as
                        well as equip you to take part in the creation of cutting-edge AI
                        technology.
                    </p>
                    <p>
                        We will start this course by understanding the fundamentals and use cases
                        for AI and move on to building next-gen intelligent apps using OpenAI's
                        powerful models and Next.js 13.
                    </p>
                    <p>
                        We'll conclude the course by learning about basic programming concepts
                        using Python, such as lists, dictionaries, classes, functions, and loops,
                        and practice writing clean and readable code with exercises for each topic.
                        We'll also learn how to make your programs interactive and how to test your
                        code safely before adding it to a project. It is a fast-paced, thorough
                        introduction to programming with Python 3.10+ that will have you writing
                        programs, solving problems, and making things that work in no time. In this
                        quarter we will also learn Git, the distributed version control system. We
                        will also review Git-based GitHub services.
                    </p>
                    <p>
                        <strong><u>Course Outline:</u></strong>
                        <strong> </strong>
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>AI-361: Deep Learning and MLOps</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p>
                        ...
                        learning how to envision, create, and maintain integrated systems that run
                        constantly in production. Production systems must manage constantly
                        changing data, in stark contrast to typical machine learning modeling. The
                        production system must also operate continuously at the lowest possible
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong><u>Cloud-Native Computing Specialization</u></strong>
                    </p>
                    <p>
                        <strong></strong>
                    </p>
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>CN-351: Certified Kubernetes Application Developer (CKAD)</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p>
                        ...
                        full advantage of the cloud computing model. Cloud-native technologies
                        empower organizations to build and run scalable applications in modern,
                    ...
                    <p>
                        ...
                        and management of containerized applications. In this course, you will
                        learn how to develop cloud applications using cloud-native technologies
                        like Containers, Kubernetes, and CDK for Kubernetes.
                    </p>
                    <p>
                        <strong><u>Course Outline:</u></strong>
                        <strong> </strong>
                    ...
                    <p>
                        <a href="https://cdk8s.io/">https://cdk8s.io/</a>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        <strong>Quarter V</strong>
                    </p>
                    ...
                    <p>
                        Terraform lets you use the same workflow to manage multiple providers and
                        handle cross-cloud dependencies. This simplifies management and
                    ...
                    <p>
                        <strong>CDK for Terraform</strong>
                    </p>
                    <p>
                        <a href="https://developer.hashicorp.com/terraform/cdktf">
                            https://developer.hashicorp.com/terraform/cdktf
                        </a>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        <strong><u>Ambient Computing and IoT Specialization</u></strong>
                    </p>
                    <p>
                        <strong></strong>
                    </p>
                    ...
                    <p>
                        ...
                        multi-device world, people don't want to spend their life fussing with
                        technology. An ambient approach gets the tech out of your way so you can
                        live your life while getting the help you need. It doesn't matter what
                        device you're using, what context you're in, whether you're talking,
                        typing, or tapping. The technology in your life works together seamlessly.
                        Ambient computing uses all aspects of modern-day technology, including
                        voice assistants, artificial intelligence, sensors, connectivity, cloud
                        computing and more.
                    </p>
                    <p>
                        If you were thinking that the IoT and ambient computing sound a lot alike,
                        you aren't wrong; the two concepts are intertwined. IoT refers to the vast
                        array of devices that connect to the internet to optimize their
                        functionality, like smart sensors and smart speakers: ambient computing
                        builds on that. Ambient computing focuses on the interaction between these
                        devices once they are connected.
                    </p>
                    <p>
                        ...
                        protocol for future smart homes. These companies include Apple, Amazon, and
                        Google. This means Apple HomeKit, Amazon Alexa, Samsung SmartThings, Google
                        Nest, and Samsung SmartThings will support the Matter standard by default
                        for all new devices.
                    </p>
                    <p>
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>AC-361: Embedded Programming using C and Rust</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p>
                        ...
                        will start by introducing embedded systems and move on to learn the C++ and
                        Rust programming languages. We'll learn about basic programming concepts
                        using C and Rust, then we will explore key concepts in electronics,
                        microcontrollers, and embedded programming. It is a fast-paced, thorough
                        introduction to programming with C and Rust that will have you writing
                        programs, solving problems, burning your code on microcontrollers, playing
                    ...
                    <ol start={parseInt("3")} type="1">
                        <li>
                            <strong>Introduction to C Part 1 </strong>
                            <u>(Weeks 3B, 4, and 5)</u>
                        </li>
                    </ol>
                    <p>
                    ...
                    <p>
                        Chapters 1-2 of <strong>"The C programming language"</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        4. <strong>C Programming Part 2 </strong><u>(Weeks 6 and 7)</u>
                    </p>
                    <p>
                        Topics 3 and 4 of <strong>"The C programming language"</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        5. <strong>Introduction to Embedded systems Part 1 </strong>	<u>(Weeks 8)</u>
                    </p>
                    <p>
                        Basic Electronics and Introduction to microcontrollers
                    </p>
                    <p>
                        Chapter 1 of <strong> "Internet of things with ESP8266" </strong>
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>Mid-Term II: C Programming Quiz 1 in Week 9 </strong>
                    </p>
                    <p>
                        Total Questions: 62, Total Time: 75 minutes
                    </p>
                    <p>
                        6. <strong>Introduction to Embedded systems Part 2 </strong>	<u>(Weeks 9-12)</u>
                    </p>
                    <p>
                        Chapters 2-5 of<strong> "Internet of things with ESP8266"</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        <a href="https://www.rust-lang.org/what/embedded">
                            https://www.rust-lang.org/what/embedded
                        </a>
                    </p>
                    <p>
                        <a href="https://crates.io/crates/esp8266">
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong><u>Genomics and Bioinformatics Specialization</u></strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        <strong><u></u></strong>
                    </p>
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>Bio-351: Python for Biologists</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p>
                        This course will focus on learning the basics of the Python programming
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>Bio-361: Bioinformatics with Python</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>
                            <u>Network Programmability and Automation Specialization</u>
                        </strong>
                    </p>
                    <p>
                        <strong><u></u></strong>
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>NPA-351: CCNA 200-301 Certification</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p>
                        ...
                        preparing for the new Cisco Certified Network Associate (CCNA) exam. This
                        comprehensive course focuses on the solutions and technologies needed to
                        implement and administer a broad range of modern networking and IT
                        infrastructure.
                    </p>
                    <p>
                        Textbook:
                    ...
                    <p style={{textAlign: 'center'}}>
                        <strong>NPA-361: Network Programmability and Automation</strong>
                    </p>
                    <p style={{textAlign: 'center'}}>
                        Duration: 13 Weeks
                    </p>
                    ...
                    <p>
                        Traditional network management techniques can't be effectively automated
                        and don't scale well. By implementing network programmability based on
                        Application Programming Interfaces, this course will assist in overcoming
                        issues of the future and help you develop the skills required for the
